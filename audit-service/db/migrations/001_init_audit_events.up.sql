...
CREATE INDEX idx_audit_events_attributes ON audit_events USING GIN (attributes);
CREATE INDEX idx_audit_events_response ON audit_events USING GIN (response);
